...
public class LegendRenderer extends Renderer {
     ...
     */
    protected void drawLabel(Canvas canvas, float x, float y, String label) {
//        int index = -1;
//        for (int i = 0; i < label.length(); i++) {
//            if (Character.isDigit(label.charAt(i))) {   //用char包装类中的判断数字的方法判断每一个字符
//                index = i;
//                break;
//            }
//        }
//        if (index > -1) {//自定义根据复合本app所需的字体颜色
//            String s1 = label.substring(0, index);
//            mLegendLabelPaint.setColor(Color.parseColor("#B3B3B3"));//画笔颜色
//            canvas.drawText(s1, x, y, mLegendLabelPaint);
//            mLegendLabelPaint.setColor(Color.parseColor("#006C85"));//画笔颜色
//            canvas.drawText(label.substring(index), x + mLegendLabelPaint.measureText(s1), y, mLegendLabelPaint);
//        } else
